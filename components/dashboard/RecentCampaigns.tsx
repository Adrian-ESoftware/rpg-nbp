    ...
    <div className="space-y-6">
      {recentCampaigns.map((campaign) => {
        ...
        return (
          ...
          >
            {/* Contêiner do ícone: agora com cantos arredondados que seguem o card principal */}
            <div className="w-28 h-28 bg-primary/20 bg-gradient-to-br from-primary/20 to-card flex items-center justify-center
                          rounded-l-xl"> {/* Adicionado rounded-l-xl para alinhar com o pai */}
            ...
            <div className="flex items-center pr-6">
              <button className="px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded flex items-center space-x-3 transition-all duration-200 shadow-lg">
